...
//turunan subclass//
class kerusakanKapal extends kecepatanKapal {
  constructor(nama, jenis, panjang, lebar, kapasitasPenumpang, kecepatanmax, rusak) {
    super(nama, jenis, panjang, lebar, kapasitasPenumpang, kecepatanmax);
    this.rusak = rusak;
  }
  infoKapal() {
    return `${super.infoKapal()} Kapal ini mengalami kerusakan pada bagian ${this.rusak}.`;
  }
}
...
const kapalFery = new kerusakanKapal("Budi Ono", "Fery", 200, 100, 500, 70, "jangkar");
